Ось повний, фінальний код бота, де всі функції об'єднані в один файл. Старий код повністю збережено, а систему скарг (`🚨`) додано як розширення в існуючу логіку перегляду анкет.
